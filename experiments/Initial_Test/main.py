...
class Net2D(object):
    def __init__(self, config):
        ...
        self.input_placeholder = tf.placeholder(dtype=tf.float16, shape=[None, None, None, 1])       # (b, h, w, 1)
        self.atlas_train_op = None

    def build(self):
        input = tf.stack([self.input_placeholder, self.input_placeholder, self.input_placeholder], axis=3)
...
if __name__ == '__main__':
    ...
    train_ops, predict_ops = slice_network.build()
