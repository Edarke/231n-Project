...
class myUnet(object):
    ...
    def train(self, train_gen, val_gen):
        ...
        callbacks = [TerminateOnNaN(), EarlyStopping(monitor='val_loss', patience=50), model_checkpoint, predict_callback]
        model.fit_generator(generator=train_gen, steps_per_epoch=len(train_gen), epochs=9000, verbose=1, callbacks=callbacks)
