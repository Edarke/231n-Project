...
if __name__ == '__main__':
    ...
    train_datagen = VolumeGenerator(brats, slices, train_ids, dim=(1, height, width, slices, 4), config=config, augmentor=augmentation.train_augmentation)
    val_datagen = VolumeGenerator(brats, slices, val_ids, dim=(1, height, width, slices, 4), config=config, augmentor=augmentation.test_augmentation)
