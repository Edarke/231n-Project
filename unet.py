...
class myUnet(object):
    ...
    def __get_unet(self):
        ...
        stem = Conv2D(filters=8, kernel_size=7, strides=1, activation='relu', kernel_initializer='he_uniform', padding='same')(inputs)
        conv224, p112 = self.__inception_pool(stem, filters=filters, block_num=1)  # (b, 112, 112, 64)
